...
\begin{itemize}
    ...
    \item \textbf{Đối chiếu chéo DB và chain:} giá trị \pkg{election.merkleRoot} lưu trong MongoDB được đối chiếu với \pkg{MerkleRootView.merkleRoot} đọc từ blockchain. Bất kỳ chênh lệch nào cũng đồng nghĩa backend đã tự ý thay đổi root sau khi commit — sự việc có thể bị bất kỳ bên kiểm toán nào phát hiện.
\end{itemize}
