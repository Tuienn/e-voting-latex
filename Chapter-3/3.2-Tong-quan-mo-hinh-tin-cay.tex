...
\begin{itemize}
    ...
    \item \textbf{Tầng 7 — Sổ cái Hyperledger Fabric:} mạng riêng được cấp phép, có chứng chỉ X.509 cho mỗi node, hỗ trợ chính sách xác nhận giao dịch (endorsement policy) và tính bất biến đảm bảo bởi liên kết băm khối liên tiếp.
\end{itemize}
