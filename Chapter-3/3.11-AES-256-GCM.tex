...
\pkg{ENCRYPTION\_KEY} là 32 byte mã hóa Base64, được nạp từ biến môi trường khi dịch vụ khởi động. Trước khi sử dụng, hệ thống kiểm tra kích thước:
