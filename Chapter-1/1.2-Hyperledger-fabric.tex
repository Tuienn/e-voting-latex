...
\begin{itemize}
    \item Kiến trúc hệ thống tương đối phức tạp với nhiều thành phần phối hợp (Peer, Orderer, CA, MSP, Channel, chaincode, v.v.), đòi hỏi thời gian tìm hiểu và làm quen lớn đáng kể đối với các nhóm phát triển mới làm quen.
