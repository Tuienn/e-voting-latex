...
\begin{itemize}
    ...
    \item $G \in E(\mathbb{F}_p)$ là điểm gốc có cấp $q$, $G \neq \mathcal{O}$, với tọa độ $(x_G, y_G)$ thỏa mãn $q \times G \equiv \mathcal{O} \pmod{p}$;
    \item $H: \{0,1\}^* \rightarrow \mathbb{Z}_q$ là một hàm băm mật mã, được mô hình hóa là một tiên tri ngẫu nhiên trong quá trình chứng minh an toàn;
...
\begin{enumerate}
    \item Chọn ngẫu nhiên số nguyên $d$ thỏa mãn $1 < d < q$. Số nguyên $d$ chính là \textit{khóa bí mật} của người sử dụng;
...
\begin{enumerate}
    \item Chọn ngẫu nhiên số nguyên $k$ thỏa mãn $1 < k < q$. Giá trị $k$ phải hoàn toàn ngẫu nhiên, được giữ bí mật và \textit{không được tái sử dụng} cho hai lần ký khác nhau;
...
\begin{enumerate}
    \item Kiểm tra điều kiện cú pháp: $r, s \in \mathbb{Z}_q$ và $r, s \neq 0$. Nếu một trong các điều kiện này không thỏa mãn, kết luận chữ ký không hợp lệ;
...
\end{equation}
Điều kiện $r' = r$ luôn thỏa mãn nên chữ ký hợp lệ luôn được thuật toán xác minh chấp nhận. Tính đúng đắn của lược đồ EC-Schnorr đã được chứng minh.
