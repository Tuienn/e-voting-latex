...
\begin{itemize}
    ...
    \item \textbf{Ký tập thể (BlindSig):} giao thức tương tác nhiều bên giữa $A$ và các thành viên trong $\mathbf{U}$; mỗi người ký đóng góp phần chữ ký riêng từ khóa bí mật của mình, được tổng hợp thành chữ ký tập thể bởi $A$ hoặc bên thứ ba tin cậy (TTP).
