...
Bộ công cụ giao diện dòng lệnh Chainlaunch CLI được cài đặt qua trình quản lý gói \pkg{npm}. Hình~\ref{fig:chainlaunch-deploy-all} trình bày toàn bộ trình tự lệnh triển khai theo sáu bước.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, keepaspectratio]{Figures/code/chainlaunch-deploy-all.png}
    \caption{Trình tự lệnh Chainlaunch và fabric-ca-client triển khai mạng blockchain e-voting (6 bước)}
...
Mã nguồn xử lý logic bầu chọn được phát triển bằng ngôn ngữ \textbf{Go} và đóng gói thành Docker Image lưu trữ tại \pkg{tuienn/votecc:latest}. Quy trình triển khai gồm 3 bước: Bước 1 khai báo siêu dữ liệu để tạo sự đồng thuận về phiên bản giữa các node; Bước 2 kéo Docker Image từ Docker Hub về các node xác thực; Bước 3 thực hiện giao dịch khởi tạo để thiết lập trạng thái gốc của sổ cái.
