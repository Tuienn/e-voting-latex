...
Trang quản trị cung cấp các chức năng vận hành cốt lõi của một cuộc bầu cử: quản lý người dùng, khởi tạo và cấu hình cuộc bầu cử, theo dõi diễn biến bỏ phiếu thời gian thực và thực thi quy trình kiểm phiếu sau khi đóng phiếu. Giao diện được thiết kế đồng nhất theo nguyên tắc thiết kế Material Design với bố cục dạng bảng điều khiển (dashboard) nhằm tối ưu cho thao tác nhập liệu và truy vấn dữ liệu khối lượng lớn.

Màn hình \textbf{Đăng nhập} là điểm vào duy nhất của hệ thống quản trị, yêu cầu xác thực bằng tài khoản nội bộ có gắn vai trò \pkg{admin}. Phiên đăng nhập được bảo vệ bằng cơ chế JWT hai cặp khóa và lưu trữ tập trung trên Redis như đã trình bày trong Chương~3.
...
\textbf{Trang quản lý danh sách bầu cử} liệt kê toàn bộ cuộc bầu cử đã, đang và sẽ diễn ra theo từng trạng thái: \pkg{PENDING}, \pkg{ACTIVE}, \pkg{CLOSED}, \pkg{COMPLETED}. Mỗi mục cho phép truy cập nhanh tới chi tiết tương ứng để cấu hình hoặc theo dõi.
...
Màn hình \textbf{Đăng nhập} xác thực cử tri bằng tài khoản đã được quản trị viên cấp quyền ở phía trang quản trị. Mỗi phiên đăng nhập thành công khởi tạo một cặp khóa cục bộ lưu trong vùng Secure Storage của thiết bị, phục vụ ký mù phiếu bầu ở các bước sau.
