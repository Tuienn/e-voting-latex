...
\begin{itemize}
    \item \textbf{Lược đồ cơ sở dữ liệu off-chain} mô hình hóa toàn bộ trạng thái vòng đời cuộc bầu cử -- từ thông tin tổ chức, cử tri, ứng viên đến bản ghi phiếu mù và biên lai xác minh -- với các ràng buộc cứng ngăn chặn trùng lặp và đảm bảo tính nhất quán trước khi bất kỳ dữ liệu nào được đẩy lên blockchain.
