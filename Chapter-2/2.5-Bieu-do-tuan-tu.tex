...
Bước \textit{Xác thực và Kiểm tra quyền} xuất hiện lặp lại trong hầu hết các luồng yêu cầu xác thực; do đó được tách thành một biểu đồ tham chiếu dùng chung (Hình \ref{fig:seq-ref-auth}) và được tham chiếu dưới dạng \pkg{ref} trong các biểu đồ còn lại nhằm tránh trùng lặp.
...
\begin{figure}[H]
    ...
    \caption{Biểu đồ tuần tự chức năng sao lưu khóa bí mật phiếu}
...
\begin{figure}[H]
    ...
    \caption{Biểu đồ tuần tự chức năng khôi phục khóa bí mật phiếu}
