...
\begin{figure}[H]
    ...
    \caption{Biểu đồ tuần tự ``Xem thông tin tài khoản cá nhân''}
...
\begin{figure}[H]
    ...
    \caption{Biểu đồ tuần tự ``Xem thông tin chi tiết người dùng''}
...
\begin{figure}[H]
    ...
    \caption{Biểu đồ tuần tự ``Cập nhật thông tin người dùng''}
...
\begin{figure}[H]
    ...
    \caption{Biểu đồ tuần tự ``Xem cuộc bầu cử theo cử tri hoặc ứng viên''}
...
\begin{figure}[H]
    ...
    \caption{Biểu đồ tuần tự ``Xem danh sách cuộc bầu cử công khai''}
