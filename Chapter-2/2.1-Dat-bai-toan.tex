...
Một hệ thống bầu cử điện tử đáng tin cậy phải đồng thời thỏa mãn sáu tính chất sau đây. Các tính chất này không độc lập mà bổ trợ cho nhau, nếu thiếu một trong các tính chất này, mức độ tin cậy của kết quả bầu cử sẽ bị suy giảm đáng kể.
