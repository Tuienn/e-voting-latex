...
\begin{itemize}
    ...
    \item \textbf{Nhóm chức năng công khai:} Phục vụ tác nhân khách, không yêu cầu xác thực, bao gồm xem danh sách cuộc bầu cử công khai, xác minh phiếu bầu, xem kết quả kiểm phiếu và kiểm toán toàn bộ số phiếu trên sổ cái blockchain.
\end{itemize}
