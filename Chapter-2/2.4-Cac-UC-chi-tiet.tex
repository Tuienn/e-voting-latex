...
\begin{figure}[H]
    ...
    \caption{Biểu đồ Use Case ``Xem thông tin tài khoản cá nhân''}
...
\begin{figure}[H]
    ...
    \caption{Biểu đồ Use Case ``Xem thông tin chi tiết người dùng''}
...
\begin{figure}[H]
    ...
    \caption{Biểu đồ Use Case ``Cập nhật thông tin người dùng''}
...
\begin{figure}[H]
    ...
    \caption{Biểu đồ Use Case ``Xem cuộc bầu cử theo cử tri hoặc ứng viên''}
...
\begin{longtable}{|p{0.22\textwidth}|p{0.72\textwidth}|}
    ...
    \end{itemize} \\
    \hline
    Điều kiện sau & Cam kết phiếu mù của cử tri được ghi lên blockchain và lưu vào cơ sở dữ liệu kèm tham chiếu giao dịch; cử tri được đánh dấu đã bỏ phiếu và nhận về biên lai để xác minh sau này. \\
    \hline
    Luồng sự kiện chính &
    \begin{enumerate}
...
\begin{figure}[H]
    ...
    \caption{Biểu đồ Use Case ``Xem danh sách cuộc bầu cử công khai''}
...
\begin{longtable}{|p{0.22\textwidth}|p{0.72\textwidth}|}
    ...
    Luồng sự kiện thay thế &
    \begin{itemize}
        \item \textbf{3a. Bản ghi phiếu không tồn tại hoặc không khớp biên lai:} trả về kết quả không hợp lệ tại tầng cơ sở dữ liệu.
